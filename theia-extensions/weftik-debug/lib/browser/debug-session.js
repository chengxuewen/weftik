...
exports.WeftikDebugSession = exports.WEFTIK_DEBUG_TYPE = void 0;
...
exports.WEFTIK_DEBUG_TYPE = 'weftik';
let WeftikDebugSession = class WeftikDebugSession extends debug_session_1.DebugSession {
    ...
    static createChannel(options) {
        ...
        const secret = (typeof config.secret === 'string')
            ? config.secret
            : 'weftik-dev-secret';
        return new debug_channel_1.WeftikDebugChannel({ socketPath, secret });
    }
};
exports.WeftikDebugSession = WeftikDebugSession;
exports.WeftikDebugSession = WeftikDebugSession = __decorate([
