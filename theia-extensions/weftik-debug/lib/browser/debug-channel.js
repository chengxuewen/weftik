...
exports.WeftikDebugChannel = void 0;
...
exports.WeftikDebugChannel = WeftikDebugChannel;
/**
 ...
 * Set WEFTIK_DEBUG_BRIDGE=real to spawn the weftik-dap-adapter binary.
 */
function selectBridge() {
    if (process.env.WEFTIK_DEBUG_BRIDGE === 'real') {
