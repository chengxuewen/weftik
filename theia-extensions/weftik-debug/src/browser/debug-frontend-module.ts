/**
 * Weftik Debug Frontend Module — Theia DI bindings.
 *
 * Registers:
 *   - DebugSessionContribution for 'weftik' debug type
...
import { WeftikDebugSessionContribution } from './debug-contribution';
...
export default new ContainerModule((bind) => {
    ...
    bind(DebugSessionContribution).to(WeftikDebugSessionContribution).inSingletonScope();
