/**
 * Weftik Debug Panel Widget — Bottom panel with connect/disconnect + quick status.
 *
...
export class DebugPanelWidget extends BaseWidget {
    static readonly ID = 'weftik-debug-panel';

    private socketPath = '/tmp/weftik-controller.sock';
    private secret = 'weftik-dev-secret';
    ...
    constructor() {
        ...
        this.title.label = 'Weftik Debug';
        this.title.caption = 'Weftik Controller Debug Panel';
    ...
    private renderHtml(): string {
        const s = this;
        let html = '<div style="font-weight:bold;margin-bottom:8px">Weftik Debug Panel</div>';
