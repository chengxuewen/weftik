...
import { WEFTIK_DEBUG_TYPE, WeftikDebugSession } from './debug-session';
import { WeftikDebugChannel } from './debug-channel';
import { Container } from '@theia/core/shared/inversify';
import { DebugSessionData } from '@theia/debug/lib/browser/debug-session';

@injectable()
export class WeftikDebugSessionContribution implements DebugSessionContribution {
    debugType = WEFTIK_DEBUG_TYPE;
...
class WeftikDebugSessionFactory implements DebugSessionFactory {
    createSession(
        sessionId: string,
        options: DebugSessionOptions & { configuration: DebugConfiguration },
        parentSession?: DebugSession,
    ): DebugSession {
        const channel = WeftikDebugSession.createChannel(
 ...
 */
class DebugSessionImpl extends WeftikDebugSession {
