...
class ScopeCanvas {
    ...
    constructor(container) {
        ...
        this.activeChannels = [];
        this.buffer = new time_series_buffer_1.TimeSeriesBuffer(1000);
        this._timeWindowSec = 10;
        this.loop = () => {
            this.draw();
    ...
    drawGrid(padL, padT, plotW, plotH) {
        const { ctx } = this;
        const gridLines = 5;
...
exports.ScopeCanvas = ScopeCanvas;
//# sourceMappingURL=scope-canvas.js.map