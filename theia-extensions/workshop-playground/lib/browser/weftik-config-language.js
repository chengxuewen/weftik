"use strict";
/**
 * Monarch tokenizer for the "Weftik Config" mini-language (.weftik files).
 *
...
exports.createWeftikConfigMonarchLanguage = createWeftikConfigMonarchLanguage;
/**
 * Create a Monarch language definition for "Weftik Config".
 *
 * Returns a plain object compatible with:
 *   monaco.languages.setMonarchTokensProvider('weftik-config', tokens);
 *
 * In a production Theia extension, this would be registered in
 * a MonacoContribution or FrontendApplicationContribution.
 */
function createWeftikConfigMonarchLanguage() {
    const language = {
...
//# sourceMappingURL=weftik-config-language.js.map