 ...
 */
@injectable()
export class IecFileIconTheme implements IconTheme, IconThemeContribution {
    readonly id = 'weftik-iec-icons';
    readonly label = 'Weftik IEC 61131-3 Icons';
    readonly description =
        'Custom icons for IEC 61131-3 (.st/.il/.ld/.fbd/.sfc), CNC (.gcode/.nc/.gco), and HMI (.hmi) files';
