...
/**
 * Default project directory name under the user's home (CODESYS-style default).
 * Resolved against the home dir at wizard runtime via EnvVariablesServer.
 */
export const DEFAULT_PROJECTS_DIR = 'Weftik-Projects';
