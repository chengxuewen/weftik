...
exports.WeftikBackendService = void 0;
...
// Service
// ---------------------------------------------------------------------------
let WeftikBackendService = class WeftikBackendService {
    constructor() {
    ...
    onStart() {
        try {
            ...
            this.bridge = require('@weftik/theia-bridge');
            ...
            console.error('[weftik-backend] Failed to load napi-rs bridge:', msg);
...
exports.WeftikBackendService = WeftikBackendService;
exports.WeftikBackendService = WeftikBackendService = __decorate([
    (0, inversify_1.injectable)()
], WeftikBackendService);
//# sourceMappingURL=weftik-backend-service.js.map