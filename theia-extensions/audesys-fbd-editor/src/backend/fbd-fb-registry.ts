...
import { PinDirection } from '../model/nodes';
...
type RawDef = [string, string, PinDirection];
...
const REGISTRY: Record<string, RawFbDef> = {
  // Timers
...
function expand(raw: RawFbDef): FbDef {
  return {
...
export function getFbDef(fbType: string): FbDef | undefined {
