...
import { BaseNode, isGateNode, isFunctionBlockNode, GateType, findPin } from '../model/nodes';
import { BaseEdge } from '../model/edges';
...
function emitGateNode(
  node: import('../model/nodes').GateNode,
  graph: FbdGraph,
...
function emitFbNode(
  node: import('../model/nodes').FunctionBlockNode,
  graph: FbdGraph,
  incoming: Map<string, BaseEdge[]>,
  wireLabels: Map<string, string>,
  lines: string[],
