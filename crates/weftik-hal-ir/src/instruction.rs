...
impl Instruction {
    ...
    pub fn load_imm(reg: u8, val: weftik_hal_core::HalValue) -> Self {
        Instruction {
            opcode: Opcode::Load,
    ...
    pub fn jump(target: u32) -> Self {
        Instruction {
            opcode: Opcode::Jump,
            operands: vec![Operand::Immediate(weftik_hal_core::HalValue::U32(target))],
        }
    }
    ...
    pub fn timer_run(timer_idx: u8, in_reg: u8, pt_ms: u32, kind: u8) -> Self {
        Instruction {
            ...
            operands: vec![
                Operand::Immediate(weftik_hal_core::HalValue::U32(timer_idx as u32)),
                Operand::Register(in_reg),
                Operand::Immediate(weftik_hal_core::HalValue::U32(pt_ms)),
                Operand::Immediate(weftik_hal_core::HalValue::U32(kind as u32)),
            ],
        }
    }
    ...
    pub fn counter_run(counter_idx: u8, cu_reg: u8, cd_reg: u8, pv: u32, kind: u8) -> Self {
        Instruction {
            ...
            operands: vec![
                Operand::Immediate(weftik_hal_core::HalValue::U32(counter_idx as u32)),
                Operand::Register(cu_reg),
                Operand::Register(cd_reg),
                Operand::Immediate(weftik_hal_core::HalValue::U32(pv)),
                Operand::Immediate(weftik_hal_core::HalValue::U32(kind as u32)),
            ],
        }
    }
    ...
    pub fn sr_run(idx: u8, s1_reg: u8, r_reg: u8, kind: u8) -> Self {
        Instruction {
            opcode: Opcode::SrRun,
            operands: vec![
                Operand::Immediate(weftik_hal_core::HalValue::U32(idx as u32)),
