...
const SOCKET = '/tmp/weftik-controller.sock';
const BINARY = `${__dirname}/../../../target/debug/weftik-controller`;
const BINARY_RELEASE = `${__dirname}/../../../target/release/weftik-controller`;
