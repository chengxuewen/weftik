...
#[test]
#[ignore = "pre-existing infinite loop: trapezoidal G1 program never reaches Halt (repro on pre-rename history tip too); executor run_to_halt has no step cap. Root cause in weftik-cnc-motion emit_g1/JumpIf termination. See pitfalls.md 2026-09-23"]
fn test_g1_basic() {
