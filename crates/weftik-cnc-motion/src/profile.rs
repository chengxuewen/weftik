...
fn signal_binding(name: &str, signal: &str) -> weftik_hal_ir::types::SignalBinding {
    weftik_hal_ir::types::SignalBinding {
        hal_signal_name: signal.into(),
        program_var: name.into(),
        direction: weftik_hal_ir::types::Direction::Write,
        hal_pin_type: weftik_hal_core::types::HalPinType::F64,
    }
}
