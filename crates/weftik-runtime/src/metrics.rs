...
impl RuntimeMetrics {
    ...
    pub fn export_prometheus(&self) -> String {
        format!(
            "weftik_runtime_cycles_completed_total {}\n\
             weftik_runtime_signals_published_total {}\n\
             weftik_runtime_config_changes_total {}\n\
             weftik_runtime_child_restarts_total {}\n\
             weftik_runtime_health_failures_total {}\n",
...
mod tests {
    ...
    fn test_prometheus_format() {
        ...
        assert!(output.contains("weftik_runtime_cycles_completed_total 1"));
        assert!(output.contains("weftik_runtime_signals_published_total 1"));
        assert!(output.contains("weftik_runtime_config_changes_total 0"));
    }
    ...
    fn test_prometheus_format_after_reset() {
        ...
        metrics.reset();
        let output = metrics.export_prometheus();
        assert!(output.contains("weftik_runtime_cycles_completed_total 0"));
    }
