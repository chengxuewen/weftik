//! Weftik Controller — binary entry point.
//!
...
const DEFAULT_SOCKET_PATH: &str = "/tmp/weftik-runtime.sock";
...
fn main() {
    ...
    log_info!("main", "Weftik Controller started", "health_port" => health_port, "socket" => socket_path, "cycle_ms" => cycle_interval_ms);
