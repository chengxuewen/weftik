//! Weftik Controller IPC client — synchronous UDS client for the Controller wire protocol.
//!
//! # Wire Protocol (matches `crates/weftik-runtime/src/ipc.rs`)
...
// Move to a shared crate (weftik-hal-wire or FlatBuffers) when
...
/// Synchronous IPC client for the Weftik Controller's Unix Domain Socket protocol.
///
/// # Lifecycle
