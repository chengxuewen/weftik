//! Weftik Config Barrier tests — implemented from openspec/specs/config-barrier-spec.md
...
use weftik_amw_inproc::InprocQoS;
use weftik_hal_core::{ConfigCommand, ConfigStatus, HalQoS, LockLevel};
