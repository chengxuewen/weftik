---
name: doc-audit
description: "Weftik 项目文档与架构审计。并行检查架构文档、设计文档、决策记录之间的自洽性、完整性、缺口和优化机会。以交互式问答与用户逐项确认每项发现，列出详情、方案与优劣、来源、影响、推荐。支持团队模式(大型审计)和背景代理模式(轻量检查)。"
---

# 文档架构审计 (Document & Architecture Audit)

对 Weftik 项目文档体系进行全面审计。
...
核查 `docs/reference/` 中 41+ 篇参考文档的「对Weftik参考价值」→ Weftik 设计吸收情况。

**核心问题**：
- 多篇竞品一致推荐的功能/模式是否已吸收？
- 关键发现是否与当前设计矛盾？
- 已验证的模式可映射到 Weftik 架构？
