...
> 来源: vendored from github.com/affaan-m/ECC@bf70150 (MIT, 见 LICENSE.ECC-MIT)。2026-09-24 ecosystem-scan 引入；安全扫描：纯方法论文档，无 exec/网络调用。与本项目 testing.md/rust.md 冲突时以项目规则为准。
